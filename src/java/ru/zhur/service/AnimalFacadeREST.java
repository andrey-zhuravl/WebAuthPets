...
public class AnimalFacadeREST extends AbstractFacade<Animal> {
    ...
    @PersistenceContext(unitName = "WebAuthPetsPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Short id, Animal entity) {
        super.edit(entity);
    }
    ...
    public Animal find(@PathParam("id") Short id) {
